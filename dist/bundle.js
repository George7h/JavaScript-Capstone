...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _mazeapi_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mazeapi.js */ \"./src/modules/mazeapi.js\");\n\n\nconst itemCounter = async () => {\n  const amountOfSeries = await (0,_mazeapi_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n\n  const allSeries = document.getElementById('countSeries');\n  allSeries.innerHTML = amountOfSeries.length;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (itemCounter);\n\n//# sourceURL=webpack://javascript-capstone/./src/modules/itemcounter.js?");

/***/ }),

/***/ "./src/modules/mazeapi.js":
/*!********************************!*\
  !*** ./src/modules/mazeapi.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst fetchmetaData = async () => {\n  const url = 'https://api.tvmaze.com/shows';\n  const response = await fetch(url);\n  const data = await response.json();\n\n  const showData = data.map((shows) => ({\n    id: shows.id,\n    name: shows.name,\n    image: shows.image,\n    rating: shows.rating,\n    summary: shows.summary,\n    season: shows.season,\n    airdate: shows.airdate,\n  }));\n\n  return showData;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (fetchmetaData);\n\n\n//# sourceURL=webpack://javascript-capstone/./src/modules/mazeapi.js?");

/***/ }),

/***/ "./src/modules/postLikeCount.js":
/*!**************************************!*\
  !*** ./src/modules/postLikeCount.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   appId: () => (/* binding */ appId),\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__),\n/* harmony export */   postLikeCount: () => (/* binding */ postLikeCount)\n/* harmony export */ });\nconst appId = 'XgSataEYPyY1k6p4lDdg';\r\n\r\nconst postLikeCount = async (appId, showId) => {\r\n  const url = `https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/${appId}/likes`;\r\n\r\n  try {\r\n    const response = await fetch(url, {\r\n      method: 'POST',\r\n      headers: {\r\n        'Content-Type': 'application/json',\r\n      },\r\n      body: JSON.stringify({ item_id: showId }),\r\n    });\r\n\r\n    if (!response.ok) {\r\n      // console.error('Failed to update like count.');\r\n    }\r\n  } catch (error) {\r\n    // console.error('Error:', error);\r\n  }\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (postLikeCount);\n\n//# sourceURL=webpack://javascript-capstone/./src/modules/postLikeCount.js?");
